...
begin
  ...
  for k:=0 to InitNrOfIntPoly-1 do InclIndex[k]:=round(HlpValue[3,k]);
...
//Setting initial values
  ...
  begin
    ...
    for j:=1 to NrOfSeasons do setlength (InitAreaA[j],NrOfIntPoly);
    for j:=1 to NrOfSeasons do setlength (InitAreaB[j],NrOfIntPoly);
    for j:=1 to NrOfSeasons do for k:=0 to NrOfIntPoly-1 do
    begin
      InitAreaA[j,k]:=AuxValue[1,j,k];
      InitAreaB[j,k]:=AuxValue[2,j,k];
    end;
  end;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            Variable[k,SerialNr]:=StrToFloat(ItemStr);
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          Variable[k,j-1]:=StrToFloat(ItemStr);
          if GroupMark='EaU' then
