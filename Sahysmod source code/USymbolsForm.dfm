  ...
  object OutputSymbolsMemo: TMemo
    ...
    Lines.Strings = (
      ...
      '                respectively'
        ...
        '                when the rotation key  Kr=1 and equal to Cr1*f i' +
        'n eqn. 86b'
        ...
        '                only used when the rotation key Kr=2 and equal t' +
        'o Cr2*f in eqn. 93b'
        ...
        '                used when the rotation key Kr=3 and equal to Cr3' +
        '*f in eqn. 100b'
  ...
  object InputSymbolsMemo: TMemo
    ...
    Lines.Strings = (
      ...
      'Dw0'#9'Initial depth of the water table (m)'
        ...
        '              (m3/season per m2 irrigated area under group A cro' +
        'ps)'
      
        'EpB#'#9'Potential evapo-transpiration of irrigated group B crop(s) ' +
        'in season #'
      
        '              (m3/season per m2 irrigated area under group B cro' +
        'ps)'
      ...
      '               drainage of the area (-)'
        ...
        '              crop(s): fraction of irrigation and rainwater stor' +
        'ed in the root zone of A crop(s),'
      
        '              average of all irrigations and rain storms (-),  0' +
        ' < FsA < 1'
      
        'FsB#'#9'Storage efficiency of irrigation and rain water in irrigate' +
        'd land under group B'
      
        '              crop(s): fraction of irrigation and rain water sto' +
        'red in the root zone of B crop(s),'
        ...
        '              the root zone of non-irrigated lands as an average' +
        ' for all rain storms (-),'
      '              0 < FsU < 1'
      ...
      '              yes -> Kf = 1, no -> Kf = 0'
        ...
        '              Possible landuse types are: irrigated land under g' +
        'roup A crops, irrigated land under'
      '              group B crops, and non-irrigated land (U);'
      '              Kr=0'#9'no rotation'
      '              Kr=4'#9'full rotation'
      
        '              Kr=1'#9'part or all of the non-irrigated land remains' +
        ' permanently unchanged,'
      
        '                                the remaining land is under full' +
        ' rotation'
      
        '              Kr=2'#9'part or all of the irrigated land under group' +
        ' A crop(s) remains permanently'
      
        '                                unchanged, the remaining land is' +
        ' under full rotation'
      
        '              Kr=3'#9'part or all of the irrigated land under group' +
        ' B crop(s) remains permanently'
      ...
      '              (m3/season per m2 non-irrigated area)'
        ...
        '              A crop(s) in season # (m3/season per m2 irrigated ' +
        'area under group A crops)'
      
        'SoB#'#9'Outgoing surface runoff or surface drain water from irrigat' +
        'ed land under group '
      
        '              B crop(s) in season # (m3/season per m2 irrigated ' +
        'area under group B crops)'
  ...
  object KrMemo: TMemo
    ...
    Lines.Strings = (
      ...
      #9
        ...
        ' the '
      'key Kr that can reach the values 0, 1, 2, 3, and 4. '
      ''
      ...
      'over the area. '
      ''
      'The other values of Kr indicate intermediate situations: '
      ''
      
        '1.  A part or all of the non-irrigated land is permanently used ' +
        'unchanged throughout the seasons (e.g. '
      
        'permanently uncultivated land, non-irrigated grazing land, non-i' +
        'rrigated (agro-forestry, '
      'abandoned land). The rotation key Kr is set equal to 1.'
      ''
      
        '2.  A part or all of the land under group A crop(s) is permanent' +
        'ly used unchanged throughout the seasons '
      '(e.g. the land under irrigated sugarcane, double irrigated rice '
      'cropping). The rotation key Kr is set equal to 2.'
      ''
      
        '3.  A part or all of the land under group B crop(s) is permanent' +
        'ly used unchanged throughout the seasons '
      
        '(e.g. the land under irrigated orchards). The rotation key Kr is' +
        ' '
      'set equal to 3.'
      ''
